...
//            String str = " insert into guest values('" + id + "','" + number + "','" + name + "','" + gender + "','" + country + "''" + room_number + "','" + status + "','" + deposit + "')";
//
//            try {
//                conn c = new conn();
