...
public class Signup extends JFrame implements ActionListener{
    ...
    public Signup() {
        ...
        ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("hotel/management/icons/white.jpg"));
        Image i3 = i1.getImage().getScaledInstance(1300, 750,Image.SCALE_DEFAULT);
